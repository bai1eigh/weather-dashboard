...
var getWeatherInfo = function (cityname) {
    var apiCityUrl = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&units=imperial&appid=c2e06340cec451ae89feb0b682c2abf3";
    fetch(
    ...
    .then(function (cityResponse) {
        ...
        .then(function (cityResponse) {
            ...
            // Return a fetch request to the OpenWeather using longitude and latitude from previous fetch
